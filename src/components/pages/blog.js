...
class Blog extends Component {
  ...
  handleBlogDelete(blog) {
    axios.delete(
      ...
      console.log('error be here', error)
    })
  }
  ...
  getBlogItems() {
    ...
    axios.get(`https://parkernelson.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`,
      { withCredentials: true }
    ).then(response => {
      this.setState({
      ...
      <div className="blog-container">
        ...
        {this.state.isLoading ? (
          <div className="content-loader">
            {/* <FontAwesomeIcon icon={brands("galactic-republic")} /> */}
